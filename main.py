...
def hundle_bullets(yellow_bullets, red_bullets, yellow, red):
    for bullet in yellow_bullets:
        bullet.x += BULLET_VEL
...
def main():
    red = pygame.Rect(1300, 350, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
    ...
    while run:
        ...
        hundle_bullets(yellow_bullets, red_bullets, yellow, red)
